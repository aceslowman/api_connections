...
class TwitterStream
{
    ...
    //
    public function login($_consumer_key, $_consumer_secret, $_token = null, $_token_secret = null)
    //I'll want to allow for the token to be null, and then retrieve the token and secret for
    {
